...
namespace SaddleHeroesAirWays.API.Services.Interfaces
{
    public interface IBookingService
    {
        ...
        Task<BookingResponse?> GetBookingByBookingReferenceAsync(string bookingReference);
        ...
        Task<BookingResponse> UpdateBookingAsync(string bookingReference, UpdateBooking updateBooking);
    }
}
